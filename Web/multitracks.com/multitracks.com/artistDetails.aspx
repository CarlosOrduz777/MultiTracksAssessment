			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" CssClass="details-banner--hero--img" ID="imageArtistHero" />
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								<asp:Image runat="server" ID="imageArtistProfile" CssClass="details-banner--info--box--img" />
						</a>
						<h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#" id="title" runat="server"><asp:Label runat="server" ID="artistTitle"></asp:Label></a></h1>
					</div>
				</div>
				...
				<div class="discovery--container u-container">
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<asp:Repeater runat="server" ID="repeatSongs">
										<ItemTemplate>
									...
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">
											...
											<div class="ly-grid ly-grid-cranberries">
												<asp:Repeater runat="server" ID="repeatAlbums" >
													<ItemTemplate>
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p>
											<asp:Literal runat="server" ID="textBiography">
